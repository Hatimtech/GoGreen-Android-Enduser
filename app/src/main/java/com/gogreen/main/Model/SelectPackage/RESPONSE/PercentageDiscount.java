...
public class PercentageDiscount {
    ...
    String month_3;
    @SerializedName("month_4")
    String month_4;
    @SerializedName("month_5")
    String month_5;
    @SerializedName("month_6")
    String month_6;
    @SerializedName("month_7")
    String month_7;
    @SerializedName("month_8")
    String month_8;
    @SerializedName("month_9")
    String month_9;
    @SerializedName("month_10")
    String month_10;
    @SerializedName("month_11")
    String month_11;
