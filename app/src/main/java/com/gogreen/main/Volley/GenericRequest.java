...
public class GenericRequest<T> extends JsonRequest<T> {
    ...
    public GenericRequest(int method, String url, Class<T> classtype, Object toBeSent,
        ...
        configureRequest();
        CommonUtils.log(Constants.VOLLEY_REQUEST, new Gson().toJson(toBeSent));
    }
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        String jsonLog = null;
        try {
            jsonLog = new String(response.data, HttpHeaderParser.parseCharset(response.headers));
            CommonUtils.log(Constants.VOLLEY_TAG, jsonLog + " ");
        } catch (Exception e) {
            CommonUtils.log(Constants.VOLLEY_TAG, jsonLog + " ");
        }
        ...
        if (muteRequest) {
            ...
            try {
                ...
                //  CommonUtils.log(CONSTANTS.VOLLEY_ERROR,e.getMessage());
